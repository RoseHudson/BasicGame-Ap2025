...
class TestPlayer(unittest.TestCase):
    ...
    def test_increase_level(self):
        ...
        3) Other Functions: __init__
        4) Tests if the increase_level method correctly increases the player's level if they are not already the maximum level.
        5) This test should pass if the code is perfect.
    ...
    def test_increase_level_max(self):
        ...
        2) Function: increase_level
        3) Other Functions: __init__
        4) Tests if the increase_level method raises a ValueError when trying to increase the level beyond the maximum possible level.
        5) This test should pass if the code is perfect.
        6) This test should pass given the current state of the code.
        """
    ...
    def test_change_username(self):
        ...
        3) Other Functions: __init__
        4) Tests if the change_username method correctly changes the player's username when a valid new username is provided.
        5) This test should pass if the code is perfect.
        6) This test should pass given the current state of the code.
        """
        player = Player(1, "JohnDoe")
    ...
    def test_change_username_empty(self):
        ...
        2) Function: change_username
        3) Other Functions: __init__
        4) Tests if the change_username method raises a ValueError when the new username provided is an empty string.
        5) This test should pass if the code is perfect.
        6) This test should pass given the current state of the code.
        """
        player = Player(1, "JohnDoe")
    ...
    def test_change_username_invalid_type(self):
        ...
        2) Function: change_username
        3) Other Functions: __init__
        4) Tests if the change_username method raises a TypeError when the new username provided is of an invalid type.
        5) This test should pass if the code is perfect.
        6) This test should pass given the current state of the code.
        """
        player = Player(1, "JohnDoe")
...
class TestAllPlayers(unittest.TestCase):
    ...
    def test_add_player(self):
        ...
        3) Other Functions: AllPlayers.__init__, Player.__init__
    ...
    def test_invalid_add_player(self):
        """
        1) Class: AllPlayers
        2) Function: add_player
        3) Other Functions: AllPlayers.__init__, Player.__init__ 
        4) Tests if the add_player method raises a TypeError when trying to add an object that is not of the Player type.
        5) This test should fail if the code is perfect.
        6) This test should pass given the current state of the code because the add_player method doesn't check if the new object is of type Player.
        """
        player_db = [Player(1, "JohnDoe")]
        all_players = AllPlayers("2021-01-01", player_db)
        fake_player = {'id': 12, 'username': 'chosenName', 'level': "Noob"}
        with self.assertRaises(TypeError):
            all_players.add_player(fake_player)
    ...
    def test_all_player_details(self):
        ...
        3) Other Functions: AllPlayers.__init__, Player.__init__, Player.return_player_details
